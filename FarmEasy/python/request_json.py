...
class request_json(object):
    ...
    def analyze(self,st,ct):
        ...
        columns = []
        options = []
        columns.append({'key':'yield', 'full_name':'Yield (BU/ACRE)', 'type':'numeric', 'goal':'max','is_objective': True})
        columns.append({'key':'production', 'full_name':'Production(BU)', 'type':'numeric', 'goal':'max','is_objective': True})
        ...
        columns.append({'key':'yield_irr', 'full_name':'Yield Irrigated (BU/ACRE)', 'type':'numeric', 'goal':'max'})
        columns.append({'key':'production_irr', 'full_name':'Production Irrigated (BU)', 'type':'numeric', 'goal':'max'})
        ...
        columns.append({'key':'yield_nirr', 'full_name':'Yield Non Irrigated (BU/ACRE)', 'type':'numeric', 'goal':'max'})
        columns.append({'key':'production_nirr', 'full_name':'Production Non Irrigated (BU)', 'type':'numeric', 'goal':'max'})
        ...
        columns.append({'key':'sales_irr', 'full_name':'Sales Irrigated ($)', 'type':'numeric', 'goal':'max'})
        columns.append({'key':'sales_nirr', 'full_name':'Sales Non Irrigated ($)', 'type':'numeric', 'goal':'max'})
